  ...
  return (
    <div className="flex flex-col gap-4">
        <h1 className="text-2xl font-semibold text-white">
            {isSignIn ? 'Welcome back to the ReadingDen!' : 'Create your account'}
        </h1>
        <p className= "text-light-100">
            {isSignIn ? 'Access the vast collection of resources, and stay updated': 'Please fill all the fields and upload a valid university ID to gain access to the library.'}
        </p>
    <Form {...form}>
    ...
    <p className="text-center text-base font-medium">
        {isSignIn? "New to the ReadingDen?" : "Already have an account?"}
